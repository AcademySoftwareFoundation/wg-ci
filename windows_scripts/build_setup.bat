...
SET ASWF_DIR=d:\aswf
rem set LUA_DIR=d:\aswf\lua-5.4.2_Win64_bin
...
rem SET QT_ROOT=%ASWF_DIR%\Qt\5.15.2\msvc2019_64
...
SET PATH_ORG=%PATH%
set PATH=%CMAKE_DIR%\;%PYTHON_HOME%\;%PYTHON_HOME%\Scripts\;%GIT_BIN_DIR%\;%LUA_DIR%;%PATH_ORG%;%DOXYGEN_BIN_DIR%;%ASWF_DIR%\install\bin;%TBB_DIR%\bin\intel64\vc14;
